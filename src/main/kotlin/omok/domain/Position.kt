...
data class Position(val horizontalAxis: HorizontalAxis, val verticalAxis: Int) {
    ...
    companion object {
        ...
        private const val HORIZONTAL_AXIS_ERROR_MSG = "가로축은 ${MIN_HORIZONTAL_AXIS}와 $MAX_HORIZONTAL_AXIS 사이입니다."
        private const val VERTICAL_AXIS_ERROR_MSG = "세로축은 ${MIN_VERTICAL_AXIS}과 $MAX_VERTICAL_AXIS 사이 입니다."
